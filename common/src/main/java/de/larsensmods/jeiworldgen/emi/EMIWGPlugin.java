...
public class EMIWGPlugin implements EmiPlugin {
    ...
    public static final EmiRecipeCategory WORLD_GEN_CATEGORY = new EmiRecipeCategory(new ResourceLocation(JEIWorldGenMod.MOD_ID, "world_generation"), EmiStack.of(Items.GRASS_BLOCK), EmiStack.of(Items.DIAMOND_PICKAXE));
